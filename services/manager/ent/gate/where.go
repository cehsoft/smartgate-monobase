...
func IDEQ(id int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
...
func IDIn(ids ...int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
...
func IDNotIn(ids ...int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
...
func IDGTE(id int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
...
func IDLT(id int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
...
func IDLTE(id int) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
...
func HasLanes() predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(LanesTable, FieldID),
...
func HasLanesWith(preds ...predicate.Lane) predicate.Gate {
	return predicate.Gate(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
